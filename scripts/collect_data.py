...
YOUTUBE_CHANNELS = [
    ...
    ("@LamaFache",            "lama-fache",               "Lama Fache",                  ["humour","comedie"]),
    ("@michou",               "michou",                   "Michou",                      ["gaming","humour"]),
    ("@nqtv",                 "remi-gaillard",            "Remi Gaillard",               ["humour","comedie"]),
    ("@McFlyetCarlito",       "mcfly-et-carlito",         "McFly & Carlito",             ["humour","comedie"]),
    ("@Inoxtag",              "inoxtag",                  "Inoxtag",                     ["gaming","aventure"]),
    ("@SWANtheVOICE",         "swan-et-neo",              "Swan et Neo",                 ["humour","comedie"]),
    ("@MisterVonline",        "mister-v",                 "Mister V",                    ["humour","rap"]),
    ("@joyca_yt",             "joyca",                    "Joyca",                       ["humour","comedie"]),
    ("@Mastusoul",            "mastu",                    "Mastu",                       ["humour","comedie"]),
    ...
    ("@MrCyrilMP4",           "cyrilmp4",                 "CyrilMP4",                    ["humour","vlogs"]),
    ("@ibratv",               "ibra-tv",                  "Ibra TV",                     ["humour","comedie"]),
    ("@SqueezieToo",          "squeezie-gaming",          "Squeezie Gaming",             ["gaming"]),
    ...
    ("@GoTaG4",               "gotaga",                   "Gotaga",                      ["gaming"]),
    ("@GregGuillotin",        "greg-guillotin",           "Greg Guillotin",              ["humour","comedie"]),
    ("@lemondealenversprod",  "le-monde-a-lenvers",       "Le Monde a l'Envers",        ["humour","comedie"]),

...
YOUTUBE_CHANNELS = [
    ...
    # --- Classement ADMS Top chaines YouTube France ---
    ("@TiboInShape",          "tibo-inshape",             "Tibo InShape",                ["sport","fitness","bien-etre"]),
    ("@Squeezie",             "squeezie",                 "Squeezie",                    ["gaming","humour"]),
    ("@Cyprien",              "cyprien",                  "Cyprien",                     ["humour","comedie"]),
    ("UCBa659QWEk1AI4Tg--mrJ2A", "lama-fache",             "Lama Fache",                  ["humour","comedie"]),
    ("@michou",               "michou",                   "Michou",                      ["gaming","humour"]),
    ("@nqtv",                 "remi-gaillard",            "Remi Gaillard",               ["humour","comedie"]),
    ("@LeFatShow",            "mcfly-et-carlito",         "McFly & Carlito",             ["humour","comedie"]),
    ("@Inoxtag",              "inoxtag",                  "Inoxtag",                     ["gaming","aventure"]),
    ("@SWANTheVoice",         "swan-et-neo",              "Swan et Neo",                 ["humour","comedie"]),
    ("@mistervofficial",      "mister-v",                 "Mister V",                    ["humour","rap"]),
    ("@Joyca",                "joyca",                    "Joyca",                       ["humour","comedie"]),
    ("@Mastu",                "mastu",                    "Mastu",                       ["humour","comedie"]),
    ("@LeRireJaune",          "le-rire-jaune",            "Le Rire Jaune",               ["humour","comedie"]),
    ("@FuriousJumper",        "furious-jumper",           "Furious Jumper",              ["gaming"]),
    ("@SEBFRIT",              "sebfrit",                  "Seb (SEBFRIT)",               ["humour","comedie"]),
    ("@natoo",                "natoo",                    "Natoo",                       ["humour","comedie"]),
    ("@FastGoodCuisine",      "fastgoodcuisine",          "FastGoodCuisine",             ["gastronomie","cuisine"]),
    ("@Cyrilmp4",             "cyrilmp4",                 "CyrilMP4",                    ["humour","vlogs"]),
    ("@ibratv",               "ibra-tv",                  "Ibra TV",                     ["humour","comedie"]),
    ("@squeeziegaming",       "squeezie-gaming",          "Squeezie Gaming",             ["gaming"]),
    ("@HugoPosay",            "hugo-posay",               "Hugo Posay",                  ["humour","bien-etre"]),
    ("@DrNozman",             "dr-nozman",                "Dr Nozman",                   ["sciences","vulgarisation"]),
    ("@latelierderoxane",     "latelier-de-roxane",       "L'Atelier de Roxane",        ["DIY","maison"]),
    ("@lebouseuh",            "le-bouseuh",               "Le Bouseuh",                  ["gaming"]),
    ("@Gotaga",               "gotaga",                   "Gotaga",                      ["gaming"]),
    ("@GregGuillotin",        "greg-guillotin",           "Greg Guillotin",              ["humour","comedie"]),
    ("@LemondeaLenvers",      "le-monde-a-lenvers",       "Le Monde a l'Envers",        ["humour","comedie"]),
    ("@palmashow",            "palmashow",                "Palmashow",                   ["humour","comedie"]),

...
def update_catalog(all_data):
    ...
    # Delegue a sync_compteurs : ce fichier avait sa PROPRE copie de la
    # logique (update_counters), qui ecrivait l'arrondi dans
    # numberOfItems la ou les donnees structurees veulent le compte
    # exact. Selon le script lance en dernier, le site servait 8 600
    # ou 8 613. Une seule implementation desormais.
    from sync_compteurs import appliquer
    appliquer()
